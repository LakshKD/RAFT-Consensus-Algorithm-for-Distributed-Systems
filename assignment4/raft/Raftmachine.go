...
func (msg *AppendEv) Append_Handler_F() []interface{} {
	...
	var actions = make([]interface{}, 1)
    var str string
    //fmt.Println(sm.LeaderID)
     //str = '\0'
     m := strconv.Itoa(sm.LeaderID)
     str = " Redirect To LeaderID " + m
	actions = append(actions, Commit{data: msg.data, error: str})
